 ...
 */
public class SpeedDrive implements MotorSafety, IUtility {
	...
	protected SpeedJaguar m_frontLeftMotor;
	protected SpeedJaguar m_frontRightMotor;
	protected SpeedJaguar m_rearLeftMotor;
	protected SpeedJaguar m_rearRightMotor;
	 ...
	 * 
	 * @param rearLeftMotor
	 *            The back left SpeedController object used to drive the robot.
	 * @param frontLeftMotor
	 *            The front left SpeedController object used to drive the robot
	 * @param rearRightMotor
	 *            The back right SpeedController object used to drive the robot.
	 * @param frontRightMotor
	 *            The front right SpeedController object used to drive the
	 *            robot.
	 */
	public SpeedDrive(SpeedJaguar frontLeftMotor, SpeedJaguar rearLeftMotor,
			SpeedJaguar frontRightMotor, SpeedJaguar rearRightMotor) {
		...
		setupMotorSafety();
		drive(0, 0);
		setMaxOutput(SpeedJaguar.sMaxSpeed);
	}
	...
	public void tankDrive(GenericHID leftStick, final int leftAxis,
		...
		tankDrive(leftStick.getRawAxis(leftAxis),
				rightStick.getRawAxis(rightAxis));
	}
	 ...
	 * @param squaredInputs
	 *            If true, the sensitivity will be increased for small values
	 */
	 ...
	 * @param squaredInputs
	 *            Setting this parameter to true increases the sensitivity at
	 *            lower speeds
	 */
	public void arcadeDrive(GenericHID moveStick, final int moveAxis,
			GenericHID rotateStick, final int rotateAxis, boolean squaredInputs) {
	 ...
	 * @param squaredInputs
	 *            If set, increases the sensitivity at low speeds
	 */
	...
	public void mecanumDrive_Cartesian(double x, double y, double rotation,
		...
		m_frontLeftMotor.set(wheelSpeeds[MotorType.kFrontLeft_val]
				* m_invertedMotors[MotorType.kFrontLeft_val] * m_maxOutput,
				syncGroup);
		m_frontRightMotor.set(wheelSpeeds[MotorType.kFrontRight_val]
				* m_invertedMotors[MotorType.kFrontRight_val] * m_maxOutput,
				syncGroup);
		m_rearLeftMotor.set(wheelSpeeds[MotorType.kRearLeft_val]
				* m_invertedMotors[MotorType.kRearLeft_val] * m_maxOutput,
				syncGroup);
		m_rearRightMotor.set(wheelSpeeds[MotorType.kRearRight_val]
				* m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput,
				syncGroup);
	...
	public void setLeftRightMotorOutputs(double leftOutput, double rightOutput) {
		...
		if (m_frontRightMotor != null) {
			m_frontRightMotor.set(
					-limit(rightOutput)
							* m_invertedMotors[MotorType.kFrontRight_val]
