...
/**
 * A {@link SendablePIDPositionController} is a {@link PIDController} that can be sent over to the {@link SmartDashboard} using
 ...
 * @see SmartDashboard
 */
public class SendablePIDPositionController extends PIDPositionController implements SmartDashboardData {
     ...
     */
    public SendablePIDPositionController(double p, double i, double d, PIDSource source, PIDOutput output) {
     ...
     */
    public SendablePIDPositionController(double p, double i, double d, PIDSource source, PIDOutput output, double period) {
            ...
            table.addListenerToAll(new NetworkListener() {
                ...
                public void valueChanged(String key, Object value) {
                    if (key.equals("p") || key.equals("i") || key.equals("d")) {
                        SendablePIDPositionController.super.setPID(table.getDouble("p", 0.0), table.getDouble("i", 0.0), table.getDouble("d", 0.0));
                    } else if (key.equals("setpoint")) {
                        SendablePIDPositionController.super.setSetpoint(((Double) value).doubleValue());
                    } else if (key.equals("enabled")) {
                        if (((Boolean) value).booleanValue()) {
                            SendablePIDPositionController.super.enable();
                        } else {
                            SendablePIDPositionController.super.disable();
                        }
                    }
                }
