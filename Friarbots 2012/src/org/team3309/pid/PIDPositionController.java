 ...
 * PIDOutput
 */
public class PIDPositionController implements IUtility{
    ...
    private double mScale = 1;  // factor to scale output
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDPositionController m_controller;

        public PIDTask(PIDPositionController controller) {
            if (controller == null) {
