...
/**
 * Properties is a class that allows you to read key-value pairs from the cRIO's filesystem. This allows you to change values (such as motor speeds)
 * without editing code, recompiling, and rebooting the cRIO. Properties follows the Singleton pattern, and by default reads key-value pairs from 
 * \/properties.txt
...
public class Properties {
	 ...
	 * @param path the path to the file that you want to read in
	 */
	public static void setPath(String path) {
		if(instance!=null)
			throw new IllegalArgumentException("Properties instance already created!\nUse getInstance() to use it");
		sPath = path;
	}
	...
	public Object get(String key) throws PropertiesException{
		...
		if(obj == null)
			throw new PropertiesException("Property ("+key+") was not found");
		return obj;
	}
	...
	/**
	 * Gets a property if it exists, otherwise returns a predefined default value
	 * @param key
	...
	/**
	 * Gets a String property if it exists, otherwise returns a predefined default value
	 * @param key
	...
	/**
	 * Gets a double property if it exists, otherwise returns a predefined default value
	 * @param key
	...
	/**
	 * Gets a int property if it exists, otherwise returns a predefined default value
	 * @param key
	 * @return the property if it exists, or 0 if it does not
	 */
	...
	/**
	 * Gets a long property if it exists, otherwise returns a predefined default value
	 * @param key
	 * @return the property if it exists, or 0 if it does not
	 */
	...
	/**
	 * Gets a byte property if it exists, otherwise returns a predefined default value
	 * @param key
	 * @return the property if it exists, or 0 if it does not
	 */
